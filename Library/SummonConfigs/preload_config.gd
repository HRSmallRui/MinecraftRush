...
@export var chapter5_preload: bool
@export var chapter5_boss_preload: bool
@export var chapter6_preload: bool
...
func load_request_enemy_scenes():
	...
	if chapter5_preload:
		ResourceLoader.load_threaded_request("res://Scenes/Enemies/enemy_45.tscn","",true)
		ResourceLoader.load_threaded_request("res://Scenes/Enemies/enemy_46.tscn","",true)
		ResourceLoader.load_threaded_request("res://Scenes/Enemies/enemy_47.tscn","",true)
		ResourceLoader.load_threaded_request("res://Scenes/Enemies/enemy_48.tscn","",true)
	if chapter5_boss_preload:
		ResourceLoader.load_threaded_request("res://Scenes/Enemies/enemy_58.tscn","",true)
	pass
