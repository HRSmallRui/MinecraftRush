...
static var archer_datas: Array[BasedTowerData] = [
	...
	10,16,0.5,360),
	BasedTowerData.new("投石高塔","只要喝饱暗黑重油，这些紫皮投石手便会重拳出击，将敌人压在巨石之下。",48,69,1.5,360),
...
static var magic_datas: Array[BasedTowerData] = [
	...
	3,6,3,400),
	BasedTowerData.new("女巫高塔","当地冤屈的女巫，解放后以致命魔法回馈救赎，攻击附带恶毒诅咒。",17,28,1.5,420),
...
static var bombard_datas : Array[BasedTowerData] = [
	...
	100,200,5,400),
	BasedTowerData.new("无人机控制平台","演算者与帝国工程师的强强联合！操控无人机投掷炸弹轰炸地面，自由调遣的特性让战场战术更加灵活多变。",
	24,48,1.2,360)
]
