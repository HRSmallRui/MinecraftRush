...
@export var changer_soldier_scene: PackedScene
...
var soldier_list: Array[TowerSoldier]
...
func summon_soldiers():
	for i in 2:
		var changer: TowerSoldier = changer_soldier_scene.instantiate()
		changer.linked_tower = self
