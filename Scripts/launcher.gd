...
@onready var mouse_selection_check: CheckBox = $MouseSelection/MouseSelectionCheck
...
func _ready() -> void:
	...
	if user_sav.extra_property.has("cursor_show"):
		mouse_selection_check.button_pressed = user_sav.extra_property.cursor_show
	else:
		user_sav.extra_property.cursor_show = true
...
func _on_start_button_pressed() -> void:
	...
	Global.cursor_show = mouse_selection_check.button_pressed
	get_tree().change_scene_to_file("res://Scenes/entry.tscn")
...
func _on_mouse_selection_check_pressed() -> void:
