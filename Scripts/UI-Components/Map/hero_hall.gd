...
@onready var steve_sp: TextureButton = $HeroHeadTextures/HeroContainer/SteveSP
...
func special_hero_button_process():
	steve_sp.disabled = !Map.instance.current_sav.hero_sav[11].unlocked
	pass
