...
@onready var total_component: Control = $TotalComponent
...
func _input(event: InputEvent) -> void:
	if event.is_action_pressed(fast_key) and button_state == ButtonState.Enable and Stage.instance.can_control:
		_on_button_pressed()
	pass
