...
@onready var extra_button: TextureButton = $MainUI/ExtraButton
...
func _ready() -> void:
	...
	extra_button.disabled = !user_sav.extra_property.has("extra_unlock")
...
func _on_extra_button_pressed() -> void:
	Global.change_scene("res://Scenes/GameBased/extra_contents.tscn")
	pass # Replace with function body.
